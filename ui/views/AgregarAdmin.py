...
class AgregarPropietario(QMainWindow, object):
    def setupUi(self, AgregarPropietario):
        ...
        self.gridLayout_3.addWidget(self.rol_propietario_txt, 6, 2, 1, 1)
    ...
    def retranslateUi(self, AgregarPropietario):
        AgregarPropietario.setWindowTitle(QCoreApplication.translate("AgregarPropietario", u"MainWindow", None))
